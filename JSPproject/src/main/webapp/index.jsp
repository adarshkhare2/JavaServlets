	...
	<div class="container-fluid">
		<div class="jumbotron">
			...
			<p>As we know, to communicate with a person, we need a specific
				...
				need a language is called Programming language.As we all know, the
				programming language makes our life simpler. Currently, all sectors
				(like education, hospitals, banks, automobiles, and more )
				completely depend upon the programming language.</p>
		
			<a href="login_page.jsp" class=btn autofocus="autofocus">
				<span class="fa fa-send"></span> Start For Free
			</a>
